...
//     version 1.3.0
//     from Assets/DialogueSystem/Sample Scene/Assets/Scripts/DialogueSample Player Controls.inputactions
//
...
public partial class @DialogueSamplePlayerControls : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DialogueSamplePlayerControls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""DialogueSample Player Controls"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @DialogueSamplePlayerControls m_Wrapper;
        public PlayerActions(@DialogueSamplePlayerControls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @DialogueSamplePlayerControls m_Wrapper;
        public DialogueActions(@DialogueSamplePlayerControls wrapper) { m_Wrapper = wrapper; }
